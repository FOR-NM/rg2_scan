##==============================================================================
## Project: QuEST - Script to tidy up a bit NH scan data and plot it
...
print(plot_variables(scan_list[[5]], scan_csvs$name[5]))
print(plot_variables(scan_list[[6]], scan_csvs$name[6]))
